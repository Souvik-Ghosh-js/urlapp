          ...
          <div class="row gutters-sm">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <br>
                      <a href="/forgot-password" target="_blank"><button class="btn btn-primary">Change Password</button></a>
            ...
            <div class="col-md-8">
              <div class="card mb-3">
                ...
                <input type="text" value="{{ $data['name'] }}" name="name" style="border: none;box-shadow: none;outline: none;"></input>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text" value="{{ $data['phone_number'] }}" name="phone_number" style="border: none;box-shadow: none;outline: none;"></input>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                    <input type="text" value="{{ $data['address'] }}" name="address" style="border: none;box-shadow: none;outline: none;"></input>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
